...
namespace Kata3_Delegates
{
    class MemberList : IMemberList
    {
        ...
        {
            internal static IMemberList CreateWithRandomData(int NrOfItems, AlexandrasAction alexandrasAction)
            {
    ...
    delegate void AlexandrasAction(IMember member);
}
